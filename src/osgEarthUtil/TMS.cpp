...
tileMapToXmlDocument(const TileMap* tileMap)
{
    ...
    e_tile_format->getAttrs()[ ATTR_WIDTH ] = toString<unsigned int>(tileMap->getFormat().getWidth(), ATTR_DOUBLE_PREC);
    e_tile_format->getAttrs()[ ATTR_HEIGHT ] = toString<unsigned int>(tileMap->getFormat().getHeight(), ATTR_DOUBLE_PREC);
